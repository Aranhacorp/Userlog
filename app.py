"""
MASTER CODE DEEP SEEK LOG v.1.3
...
def login_page():
    ...
    with col2:
        ...
        # ✅ ALTERAÇÃO: Removido "CLAUDE" do título abaixo da imagem
        st.markdown("<div class='main-header'><h1>USER LOG</h1></div>", unsafe_allow_html=True)
...
def menu_sidebar():
    with st.sidebar:
        ...
        <div style='text-align: center; color: #666; font-size: 0.8rem;'>
            ...
            <p>MASTER CODE DEEP SEEK LOG v.1.3</p>
            <p>© 2026 - Userlog</p>
        </div>
        """, unsafe_allow_html=True)
